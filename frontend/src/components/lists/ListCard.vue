...
/**
 * ListCard — tarjeta de una lista temática creada por el usuario.
 * Hardcodeado por ahora: en el futuro vendrá de un store de listas
 * (crear/editar/compartir) respaldado por el backend.
 */
